'use strict';
const log = require('debug-logger')('api:season:episodes:rose:revoke'),
...
exports = module.exports = async (req, res, next) => {
  ...
  try {
    ...
    const castMember = await core.SeasonCastMember.findById(req.body.castMemberId);
    await season.revokeRose(req.accessToken, episode, castMember);
    res.sendStatus(204);
  } catch (e) {
    log.error(e);
